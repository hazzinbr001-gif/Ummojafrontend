          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="bg-[hsl(222,47%,8%)] border-[hsl(222,47%,22%)] text-white placeholder:text-white/25 focus:border-primary"
                required
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-[hsl(222,47%,8%)] border-[hsl(222,47%,22%)] text-white placeholder:text-white/25 focus:border-primary pr-10"
                  required
                />
                <button
                  type="button"
